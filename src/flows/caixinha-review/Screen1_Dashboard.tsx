...
function CaixinhaRow({ currency, name, balance, yieldToday, disabled, onPress }: CaixinhaRow) {
  ...
  return (
    <ListItem
      left={<Avatar src={curr.flagIcon} size="md" />}
      title={name}
      subtitle={subtitle}
      right={right}
      trailing={null}
          ...
          {hasBalance && !hasPending && (
            <Stack direction="row" gap="sm" align="center">
              {usdYield > 0 && (
                <Text
                  variant="body-md"
                  className="text-[var(--color-feedback-success)] font-medium tracking-tight"
                >
